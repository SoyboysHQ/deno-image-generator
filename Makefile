...
help:
	...
	@echo "  make docker-test-book-takeaways-carousel - Test book takeaways carousel generation"
...
docker-test-book-takeaways-carousel:
	@echo "📖 Testing book takeaways carousel generation..."
	@./docker-test-book-takeaways-carousel.sh
