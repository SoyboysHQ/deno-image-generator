...
.PHONY: help docker-build docker-build-fresh docker-start docker-stop docker-restart docker-update docker-test docker-test-all docker-test-health docker-test-image docker-test-carousel docker-test-reel docker-test-two-image-reel docker-test-three-part-reel docker-test-book-reveal-reel docker-test-text-reel docker-test-watermark docker-test-setup docker-test-cleanup docker-logs docker-shell clean docker-rebuild
